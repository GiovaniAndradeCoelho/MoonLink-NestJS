...
export class User {
    ...
    @Column({ default: false, comment: 'Indica se o usuário está bloqueado' })
    isBlocked: boolean;

    @Column({ default: false, comment: 'Indica se o usuário está banido' })
    isBanned: boolean;

    @Column({ nullable: true, comment: 'Motivo do bloqueio' })
    blockReason?: string | null;

    @Column({ nullable: true, comment: 'Motivo do banimento' })
